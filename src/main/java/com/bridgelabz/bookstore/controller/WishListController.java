...
import com.bridgelabz.bookstore.serviceimpl.WishListServiceImpl;
...
public class WishListController {
	...
	public ResponseEntity<Response> addBookToWishList(@RequestHeader("bookId") Long bookId,@RequestHeader String token) throws BookStoreException
	{
		System.out.println("inside wishlist"+bookId);
	...
	{
		System.out.println("inside getallwishlist");
		List<Book> wishlistBooks=wishImpl.getAllWishListBooks(token);
		return new ResponseEntity<Response>(new Response("all books from wishlist", wishlistBooks, 200),HttpStatus.OK);
	}
//	
